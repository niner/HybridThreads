...
The scheduler is the place where most of the green thread logic is implemented. It's functions use the prefix \textit{Parrot\_cx} and are located in \textit{src/scheduler.c}.
